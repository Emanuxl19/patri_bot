...
def main():
    ...
    # Conversation handler for adding assets
    ...
    # Conversation handler for updating assets
    ...
    # Conversation handler for removing assets
    remove_conv_handler = ConversationHandler(
        entry_points=[CommandHandler('remove', remove_start)],
        states={
            REMOVE_CONFIRMATION: [CallbackQueryHandler(remove_confirm)],
        },
        fallbacks=[]
    )
